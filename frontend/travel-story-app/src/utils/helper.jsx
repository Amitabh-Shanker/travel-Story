...
import NO_SEARCH_DATA_IMG from "../assets/images/search-not-found.png";
import NO_FILTER_DATA_IMG from "../assets/images/date-not-found.png";
...
export const getEmptyCardMessage = (filterType) => {
  switch (filterType) {
    ...
    default:
      return `Start creating your Travel Story!Click the 'Add' button to jot down your thoughts,ideas and memories.Let's get started!`;
  }
};
